...
imped_active <- imped_active %>% 
  mutate(modo = factor(Modo)
...
ft2 <- ftExtra::as_flextable(grouped_df1, col_keys = names(grouped_df1), groups_to = "merged")


ft2 <- set_table_properties(ft1, layout = "autofit", width = 1)
...
ft3 <- ftExtra::as_flextable(grouped_df1, col_keys = names(grouped_df1), groups_to = "merged")


ft3 <- set_table_properties(ft1, layout = "autofit", width = 1)
